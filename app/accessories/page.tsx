...
export const metadata: Metadata = buildPageMetadata({
  title: 'Accessories',
  description: 'Browse phone accessories and gadgets from Rujama Phones Shop in Kigali, Rwanda.',
  path: '/accessories',
});

function AccessoriesGridSkeleton() {
  return (
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-4">Accessories</h1>
          <p className="text-slate-600 mb-8">
            Explore phone accessories, chargers, cases, headphones and more curated for Kigali customers.
          </p>
          <Suspense fallback={<AccessoriesGridSkeleton />}>
            <ProductsGrid initialCategory="ACCESSORY" />
          </Suspense>
        </div>
      </main>
      <Footer />
