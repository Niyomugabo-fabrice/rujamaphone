...
export const metadata: Metadata = buildPageMetadata({
  title: "Pay in Parts",
  description:
    "Buy a phone with a flexible pay-in-parts plan from Rujama Phones Shop in Kigali with clear first payment and support.",
  path: "/pay-in-parts",
...
export default function PayInPartsPage() {
  return (
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
        ...
        <section className="mt-10 grid gap-8 lg:grid-cols-[1.65fr_1fr]">
          ...
          <aside className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <a
              href="https://wa.me/250788773754?text=Hi,%20I%20want%20to%20get%20a%20phone%20with%20pay%20in%20parts"
              target="_blank"
